...
export default function ChatPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 flex gap-4">
      ...
      <div className="hidden md:flex md:flex-col w-72 bg-white dark:bg-gray-800 rounded-lg p-4 h-[calc(100vh-4rem)]">
        <div className="mb-4">
      ...
      {/* Main chat area */}
      <div className="flex-1 bg-white dark:bg-gray-800 rounded-lg flex flex-col h-[calc(100vh-4rem)]">
        {/* Chat header */}
